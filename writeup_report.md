...
[image6]: ./img/accuracy.png "Accuracy"
[image7]: ./img/steering_angle_hist.png "Histogram of steering angles"
...
My model consists of a convolution neural network with a 64x2x2 convolution layer, a 2x2 max pooling layer, a 32x3x3 convolution layer, another 2x2 max pooling layer, and 5 dense layers with depths from 1024 to 1 (model.py, lines ? to ?)
...
The model was trained and validated on different data sets to ensure that the model was not overfitting (model.py lines ?). The model was tested by running it through the simulator and ensuring that the vehicle could stay on the track.
